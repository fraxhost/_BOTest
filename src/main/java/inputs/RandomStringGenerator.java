...
public class RandomStringGenerator {
    ...
    public String nextValue() {
        ...
        // Get string params
        int stringConf = 4*(includeAlphabetic ? 1 : 0) + 2*(includeNumbers ? 1 : 0) + (includeSpecialCharacters ? 1 : 0);
        int stringLength = new RandomDataGenerator().nextInt(minLength, maxLength);
